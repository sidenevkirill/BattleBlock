...
class BallSpeedBonus extends AbstractBonus {
  ...
  getMessage() {
    return "Скорость мяча изменилась";
  }
...
class HeroSpeedBonus extends AbstractBonus {
  ...
  getMessage() {
    return "Ваша скорость изменилась";
  }
...
class FieldView {
  ...
  onGameLost() {
    this.gameOver("Вы програли");
  }

  onGameWon() {
    asafonov.score.processGameWon();
    this.gameOver("Вы победили!");
  }
  ...
  destroy() {
    ...
    console.log("Уничтожать поле зрения");
  }
}
class HeroView {
